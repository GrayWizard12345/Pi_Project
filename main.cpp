...
void* video_loop(void*)
{
	...
	if (!right_buttom_lines.empty()) {
	    // Separate lines into left and right lines
	    left_right_lines_right_buttom_frame = lanedetector.lineSeparation(right_buttom_lines, img_right_buttom_mask);
    
	    // Apply regression to obtain only one line for each side of the lane
	    lane_right_buttom_frame = lanedetector.regression(left_right_lines_right_buttom_frame, img_right_buttom_mask);
	...
	if (!center_buttom_lines.empty()) {
	    // Separate lines into left and right lines
	    left_right_lines_center_buttom_frame = lanedetector.lineSeparation(center_buttom_lines, img_center_buttom_mask);
    
	    // Apply regression to obtain only one line for each side of the lane
	    lane_center_buttom_frame = lanedetector.regression(left_right_lines_center_buttom_frame, img_center_buttom_mask);
